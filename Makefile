...
CFLAGS+=-I/usr/include/wine/msvcrt -I/usr/include/wine/windows -DWIN32 -D_WINDOWS -W -D_MBCS -fexceptions -O2 -I3dc -I3dc/avp -Dengine=1 -I3dc/avp/support -D__STDC__ -I3dc/avp/win95 -DAVP_DEBUG_VERSION -I3dc/avp/win95/frontend -I3dc/avp/win95/gadgets -I3dc/include -I3dc/win95
LD=$(CXX) $(CXXFLAGS)
LDFLAGS=
TARGET=avpprog.exe
...
CFLAGS+=-I/usr/include/wine/msvcrt -I/usr/include/wine/windows -I3dc/include -I3dc/win95 -W -DWIN32 -fexceptions -g -O0 -D_DEBUG -I3dc -D_WINDOWS -I3dc/avp -D_MBCS -I3dc/avp/support -Dengine=1 -I3dc/avp/win95 -D__STDC__ -I3dc/avp/win95/frontend -DAVP_DEBUG_VERSION -I3dc/avp/win95/gadgets
LD=$(CXX) $(CXXFLAGS)
LDFLAGS=
...
CFLAGS+=-I/usr/include/wine/msvcrt -I/usr/include/wine/windows -DWIN32 -D_WINDOWS -W -D_MBCS -fexceptions -O2 -I3dc -I3dc/avp -Dengine=1 -I3dc/avp/support -D__STDC__ -I3dc/avp/win95 -I3dc/avp/win95/frontend -I3dc/avp/win95/gadgets -I3dc/include -I3dc/win95
LD=$(CXX) $(CXXFLAGS)
LDFLAGS=
TARGET=AvP.exe
LDFLAGS+=-L3dc -Wl,--subsystem,windows
