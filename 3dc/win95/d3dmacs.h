/*
 * Copyright (C) 1995, 1996 Microsoft Corporation. All Rights Reserved. File:
 * d3dmacs.h Useful macros for generating execute buffers. Consult the D3D sample
 * code for examples of their usage. Use OP_NOP to QWORD align triangle and line
 * instructions.
 */
...
#define MAKE_MATRIX(lpDev, handle, data) \
	if(lpDev->lpVtbl->CreateMatrix(lpDev, &handle) != D3D_OK) return FALSE; \
	if(lpDev->lpVtbl->SetMatrix(lpDev, handle, &data) != D3D_OK) return FALSE
#define RELEASE(x) \
	if(x != NULL) \
	{ \
		x->lpVtbl->Release(x); \
...
#ifdef __cplusplus
#define MAKE_MATRIX(lpDev, handle, data) \
	if(lpDev->CreateMatrix(&handle) != D3D_OK) return FALSE; \
	if(lpDev->SetMatrix(handle, &data) != D3D_OK) return FALSE
#define RELEASE(x) \
	if(x != NULL) \
	{ \
		x->Release(); \
...
/*
 ...
 =======================================================================================================================
 */
#define OP_MATRIX_MULTIPLY(cnt, ptr)	PUTD3DINSTRUCTION(D3DOP_MATRIXMULTIPLY, sizeof(D3DMATRIXMULTIPLY), cnt, ptr)
...
/*
 ...
 =======================================================================================================================
 */
#define OP_STATE_LIGHT(cnt, ptr)	PUTD3DINSTRUCTION(D3DOP_STATELIGHT, sizeof(D3DSTATE), cnt, ptr)
...
/*
 ...
 =======================================================================================================================
 */
#define OP_STATE_TRANSFORM(cnt, ptr)	PUTD3DINSTRUCTION(D3DOP_STATETRANSFORM, sizeof(D3DSTATE), cnt, ptr)
...
/*
 ...
 =======================================================================================================================
 */
#define OP_STATE_RENDER(cnt, ptr)	PUTD3DINSTRUCTION(D3DOP_STATERENDER, sizeof(D3DSTATE), cnt, ptr)
...
/*
 ...
 =======================================================================================================================
 */
#define OP_PROCESS_VERTICES(cnt, ptr)	PUTD3DINSTRUCTION(D3DOP_PROCESSVERTICES, sizeof(D3DPROCESSVERTICES), cnt, ptr)
...
/*
 ...
 =======================================================================================================================
 */
#define OP_TRIANGLE_LIST(cnt, ptr)	PUTD3DINSTRUCTION(D3DOP_TRIANGLE, sizeof(D3DTRIANGLE), cnt, ptr)
...
/*
 ...
 =======================================================================================================================
 */
#define OP_LINE_LIST(cnt, ptr)	PUTD3DINSTRUCTION(D3DOP_LINE, sizeof(D3DLINE), cnt, ptr)
...
/*
 ...
 =======================================================================================================================
 */
#define OP_NOP(ptr)			PUTD3DINSTRUCTION(D3DOP_TRIANGLE, sizeof(D3DTRIANGLE), 0, ptr)
#define OP_EXIT(ptr)		PUTD3DINSTRUCTION(D3DOP_EXIT, 0, 0, ptr)
#define QWORD_ALIGNED(ptr)	!(0x00000007L & (ULONG) (ptr))
#endif /* __D3DMACS_H__ */
