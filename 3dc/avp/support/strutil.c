/*$T strutil.c GC 1.140 NO_DATE NO_TIME */

/*
 * STRUTIL.C Created 13/11/97 by David Malcolm from Headhunter code: more
 * carefully specified versions of the C string library functions, to act on
 * ProjChars rather than chars
 */
#include "3dc.h"
#include "strutil.h"
